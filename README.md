...
```sh
grep -rl 'algolia' ./ | xargs sed -i '' 's/algolia/{YOUR INTEGRATION NAME}/g'
```
...
Want to contribute? Ping us on `algolia` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/algolia.git
    cd algolia
    ```
